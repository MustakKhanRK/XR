#MKR
import os,sys,time,json,random,re,string,platform,base64,uuid#MKR
...
os.system('clear')
print(f' [{xr}■{x}] {P}Follow My Github Account...');time.sleep(2)
...
def xxr():
    ...
    if MKR in ["1", "01"]:
        os.system('curl -L https://github.com/X-R-404/A/blob/main/filev1.cpython-311.so?raw=true -o Mkr64.so')
        import Mkr64
    else:
        import Mkr64
    if MKR in ["2", "02"]:
